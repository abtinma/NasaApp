...
projects = [
...

  {
    ...
    "skills_needed": ["Web Development", "UX/UI Design", "E-commerce"]
  },
  {
...

  {
    ...
    "skills_needed": ["Biology", "Conservation", "Community Engagement"]
  },
  {
...

  {
    ...
    "skills_needed": ["Tech-Savvy", "Education", "Community Outreach"]
  },
  {
  ...
  },
  {
    ...
    "skills_needed": ["Gardening", "Landscaping", "Community Engagement"]
  },
  {
...

  {
    ...
    "skills_needed": ["Mentoring", "Coaching", "Youth Development"]
  },
   {
...
project_names = [
    ...
    "Sustainable Urban Farming for the Modern Age",
    "Breaking Language Barriers with AI-Powered Translation",
    "Pioneering the Future of Renewable Energy Forecasting",
    "Creating the Ultimate Smart Home Experience",
    "Urban Farming for a Sustainable Tomorrow",
    "Empowering Rural Communities with Renewable Energy",
    "Your Pocket Guide to Environmental Conservation",
    "A Virtual Reality Museum that Brings History to Life",
    "The Next Level in AI-Driven Language Translation",
    "Monitoring Renewable Energy the Smart Way",
    "Empowering Communities to Live Sustainably",
    "Optimizing Renewable Energy Management",
    "Revolutionizing Online Shopping Experience",
    "Your Personal Task Manager in Your Pocket",
    "Preserving Biodiversity One Step at a Time",
    "Innovating Renewable Energy for the Future",
    "Digital Literacy for Underserved Communities",
    "Your Health and Wellness Companion App",
    "Uniting the World for Environmental Conservation",
    "Accelerating Renewable Energy Adoption",
    "Nurturing Community Through Gardening",
    "AI-Driven Solutions for Healthcare",
    "Leading the Charge in Environmental Cleanup",
    "Mentoring the Leaders of Tomorrow",
    "Satellite Imagery for Cosmic Patterns",
    "Autonomous Reef Monitoring Robot",
    "Marine Migration Analytics",
    "Marine Species ID App",
    "Automated Ocean Pollution Tracker",
    "VR Lunar Habitat Simulator",
    "Space Weather Predictor",
    "Exoplanet Detection Algorithms",
    "Drone-aided Search & Rescue",
...
# Adding project names to each project dictionary
for i, project in enumerate(projects):
    project['project_name'] = project_names[i]


def save_to_json(data, filename):
    with open(filename, 'w') as f:
        json.dump(data, f, indent=4)
# Saving the updated projects to a JSON file
